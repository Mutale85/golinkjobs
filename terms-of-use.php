		...
		<div class="main_section">
			<div class="row">
				...
				<div class="col-md-7 text-secondary div-intro">
					...
					<p>The accssremotejobs.com website located at https://accssremotejobs.com is a copyrighted work belonging to OSABOX. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
					...
					<p>Token are points that accssremotejobs.com provides to you either for free when you add up a User Information or for a fee when you no longer have free points to use. You agree that every User information you provide, there is no guarantee that you will get free tokens, as it is the discretion of the website owners. </p>
					<p>You also also agree to the effect that every time you search for User Information to match them with the data stored by accssremotejobs.com will be, tokens or points will be deducted from your user account, and when you reach Zero, you will have the options to buy new tokens.</p>
					...
					<p><strong>Cookies and Web Beacons.</strong> Like any other website, accssremotejobs.com uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p> -->

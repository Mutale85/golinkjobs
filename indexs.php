...
<head>
	...
	<meta name="title" content="Access Remote Jobs">
	...
	<meta property="og:title" content="Access Remote Jobs">
	...
	<meta property="twitter:title" content="Access Remote Jobs">
...
<body>
	<div class="main_container">
		<div class="navbar_">
			<img src="images/remotejobsLogo.png" class="logo">
			<nav class="fixed">
				<ul id="menuList">

    					...
    					<div class="forms">
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="form-group col-md-6 mb-5">
												...
												<input type="text" name="company_location" id="company_location" class="form-control" placeholder="remote company based in the USA, India, UK, etc" required>
											</div>
											<div class="form-group col-md-12 mb-5">
											...
											<div class="form-group col-md-12 mb-5">
												...
												<textarea name="company_profile" id="company_profile" class="form-control" rows="4" placeholder="Let candidates know what your company is about"></textarea>
											</div>
										</div>
									</div>
									<div class="card-footer d-flex justify-content-between"> 
										<button class="btn btn-secondary" type="submit" id="continue">Save & Continue <i class="bi bi-arrow-right"></i></button>
										<!-- <button class="btn btn-outline-secondary btn-sm" type="button" id="skipBtn">Save & Continue <i class="bi bi-arrow-right"></i></button> -->
									</div>
								</div>
							</form>
	    					<form method="post" id="jobForm" enctype="multipart/form-data">
	    						<div class="row">
		    						...
		    						<div class="col-md-12">
		    							<label>
											<input class="form-check-input mb-3" type="checkbox" name="terms" id="terms" required > I agree to <a href="terms-and-conditions">Terms of Job Listing</a>
										</label>
										<div class="d-flex justify-content-between">
											<button class="btn btn-outline-secondary" id="back_to_1" type="button"><i class="bi bi-arrow-left"></i> Previous</span> </button>
    	...
    	<script>
			...
			$(function(){
				...
				$("#profileForm").submit(function(e){
					...
					var url = 'includes/submitProfile';
					$.ajax({
						...
						contentType: false,
						beforeSend:function(){
							$("#continue").html("<i class='spinner-border'></i> Processing...");
						},
						success:function(data){
							successNow(data);
							$("#continue").html('Continue <i class="bi bi-arrow-right"></i>');
